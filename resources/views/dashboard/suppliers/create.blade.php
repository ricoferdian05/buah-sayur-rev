...
@section('container')
    ...
    <div class="col-md-4">
        <form action="/dashboard/suppliers" method="POST" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('harga_pasok') is-invalid  @enderror" id="harga_pasok" name="harga_pasok" required autofocus value="{{ old('harga_pasok') }}">
                @error('harga_pasok')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('persentase') is-invalid  @enderror" id="persentase" name="persentase" required autofocus value="{{ old('persentase') }}">
                @error('persentase')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
