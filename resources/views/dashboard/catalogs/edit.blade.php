        ...
        <form action="/dashboard/catalogs/{{ $catalog->slug }}" method="POST" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_barang') is-invalid  @enderror" id="nama_barang"
                    name="nama_barang" required autofocus value="{{ old('nama_barang', $catalog->nama_barang) }}">
                @error('nama_barang')
            ...
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug"
                    required value="{{ old('slug', $catalog->slug) }}">
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input id="desk_barang" type="hidden" name="desk_barang"
                    value="{{ old('desk_barang', $catalog->desk_barang) }}">
