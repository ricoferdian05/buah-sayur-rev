            ...
            <div class="row">
                <div class="section-title col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        <li>
                            <h2><a href="/home/catalogs">Semua</h2>
                        </li>
                        @foreach ($categories as $category)
                            <li>
                                <h2><a
                                        href="/home/catalogs?kategori={{ $category->slug }}">{{ $category->nama_kategori }}</a>
                                </h2>
                            </li>
                        @endforeach
                        <li>
                ...
                <div class="col-md-6">
                    <form action="/home/catalogs">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari katalog.." name="search"
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <small class="text-muted">
                                            Oleh <a href="/home/catalogs?user={{ $catalog->user->username }}"
                                                class="text-decoration-none">{{ $catalog->user->nama }}</a>
                                            {{ $catalog->updated_at->diffForHumans() }}
                                        </small>
                                    </p>
                                    ...
                                    @endif
                                    <a href="/home/catalogs/{{ $catalog->slug }}"
                                        class="text-decoration-none btn btn-primary" style="width: 100%;">Selengkapnya</a>
                                    <a href="/home/users/{{ $catalog->id_user }}"
                                        class="text-decoration-none btn btn-success mt-1" style="width: 100%;">Informasi
                                        Toko</a>
                                    <a href="{{ $catalog->user->link_toko }}"
                                        class="text-decoration-none btn btn-warning mt-1" style="width: 100%;">Kunjungi
                                        Marketplace</a>
                                </div>
                            </div>
                        </div>
